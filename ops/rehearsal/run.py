...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "rate_limit, server_error, server_error_mid_stream, timeout, auth, "
            "insufficient_balance. Note server_error is a PRE-GENERATION "
            "503 and provably costs nothing, so it never latches the cost "
            "circuit; server_error_mid_stream is the 503 that does. "
