...
import { ScatterChart, SankeyChart, GraphChart, FunnelChart, PieChart, TreemapChart } from "echarts/charts";
 ...
 * actually uses (scatter, sankey, graph, funnel, pie/donut, treemap)
 ...
 * over Tremor's DonutChart because it uses a compact custom center label.
 * `TreemapChart` covers position-level
 ...
 * funnel work) and are reused as-is. `GraphicComponent` backs
