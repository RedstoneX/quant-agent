...
import { PositionsTreemap } from "./ui/PositionsTreemap";
      ...
      {positions.length > 0 && (
        <>
          <div className="mb-2.5">
            <div className="text-[0.68rem] text-dim uppercase tracking-wide mb-1.5">Portfolio shape — size by exposure, color by P&amp;L</div>
