...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      "^/(account|positions|holdings|orders|trades|runs|decisions|agents|analysts|reflections|candidates|journal|research|search|health|prices|quotes|events|company)": {
