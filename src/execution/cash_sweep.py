...
class CashSweeper:
    ...
    def park_excess(self, ctx) -> dict | None:
        ...
        # A daily-loss-breach gate used to sit here: no parking on a day
        # the account-level breaker had fired. That breaker was removed
        # 2026-09-20 on the owner's instruction (retired item 32,
        # docs/INCIDENT_HISTORY.md), so there is no breach state to read.
