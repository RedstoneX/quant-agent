...
The only real-day scenario, `pm_selection`, now replays a day whose every
actionable candidate has a computable structural reward:risk (item 72,
closed 2026-09-14; `docs/INCIDENT_HISTORY.md`).
