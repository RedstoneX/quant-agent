...
2. **A failed request is charged as if it ran.** A provider 429 returns nothing and bills nothing, but is recorded as unknown cost, which makes the day unreconcilable and hard-stops the desk. This is what took production down on 2026-08-28.
...
- `max_paid_sessions_per_mode_per_day` 2 to 8
