...
night (see `docs/OUTCOME.md`), so that part stands. The proposal to
widen the conviction bands back to their pre-compression values is a
fresh design choice that has NOT been reviewed or approved — restored
on a new PR, open, pending real review.
...
**Proposed, not yet decided** — `docs/WORK.md` item 32 stays open on this
piece until the owner actually reviews it.
