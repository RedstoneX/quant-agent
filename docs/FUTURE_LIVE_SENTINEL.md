...
## Appendix — future idea: an options desk cloned from QAMC

**Status: owner idea, recorded 2026-09-14. Not scheduled, not authorized.** Filed here because it is future-only; it adds nothing to WORK.md.
