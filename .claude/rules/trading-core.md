...
- Current Mission Control Stages 3–5 do **not** authorize trading/risk behavior changes.
...
- Before changing trading-core behavior, read `docs/architecture/SAFETY_BOUNDARIES.md` and the relevant portion of `docs/reference/UPSTREAM_CLAUDE_2026-08-09.md`.
